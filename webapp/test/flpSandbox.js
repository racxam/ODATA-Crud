		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Odata_operations",
									"targetURL": "#comcrudodatacrud-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comcrudodatacrud-display": {
								"semanticObject": "comcrudodatacrud",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.crud.odatacrud",
									"url": sap.ui.require.toUrl("com/crud/odatacrud")
								}
							}
						}
					}
